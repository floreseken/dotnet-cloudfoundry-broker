    ...
    public class CatalogService : ICatalogService
    {
        ...
        private static readonly JObject ServiceMetadata =
            JObject.FromObject(
                new
                {
                    displayName = "Scaffold service",
                    longDescription = "The magnificent and well-known scaffold service"
                });
            ...
            new Catalog
            {
                Services =
                {
                    ...
                    new Service
                    {
                        ...
                        Description = "The magnificent and well-known scaffold service",
